...
public abstract class AbstractMarketDataExchangeHandler implements IMarketDataExchangeHandler {
	...
	public abstract List<Trade> getTradesWithCache(CurrencyPair currencyPair, Long fromId, Long fromTime, Long toTime,
			Long limit) throws IOException;

	@Override
	public List<Trade> getTrades(CurrencyPair currencyPair, Long fromId, Long fromTime, Long toTime, Long limit)
			throws IOException {
		return marketDataService.getTrades(currencyPair).getTrades();// get all
																		// by
																		// default
																		// ,works
																		// different
	...
	public OrderBook getOrderBook(CurrencyPair pair, Object... args) throws IOException {
		return marketDataService.getOrderBook(pair); // works different in each
														// echange
	}
