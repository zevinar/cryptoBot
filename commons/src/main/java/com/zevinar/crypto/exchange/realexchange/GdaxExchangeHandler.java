...
public class GdaxExchangeHandler extends AbstractMarketDataExchangeHandler {
	private static final Logger LOG = LoggerFactory.getLogger(GdaxExchangeHandler.class);

	public GdaxExchangeHandler() {

		INSTANCE = ExchangeFactory.INSTANCE.createExchange(ExchangeEnum.GDAX.getExchangeName());
		init();
	}
