...
public class CryptopiaExchangeHandler extends AbstractMarketDataExchangeHandler {
	private static final Logger LOG = LoggerFactory.getLogger(CryptopiaExchangeHandler.class);

	public CryptopiaExchangeHandler() {

		INSTANCE = ExchangeFactory.INSTANCE.createExchange(ExchangeEnum.CRYPTOPIA.getExchangeName());
		init();
	}
